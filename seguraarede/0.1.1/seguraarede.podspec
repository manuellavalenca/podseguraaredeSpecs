#
#  Be sure to run `pod spec lint seguraarede.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "" => "manuella.valenca@ufpe.br" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "manuella.valenca@ufpe.br" }
  ...
  spec.source       = { :git => "https://github.com/manuellavalenca/podseguraarede.git", :tag => "#{spec.version}" }
